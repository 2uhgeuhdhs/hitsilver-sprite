...
- Шаги выполнения:
  - [ ] Добавить анализ бандла (rollup-plugin-visualizer) и базовый Lighthouse-отчёт
  - [ ] Перевести тяжёлые части на динамический импорт (lazy, route-based splitting)
  - [ ] Оптимизировать импорты иконок/библиотек (tree-shaking)
  - [ ] Lazy-load изображений и responsive srcset/AVIF/WebP
...
- Шаги выполнения:
  - [ ] Добавить подкатегории `women` и `smart` с тестовыми товарами
  - [ ] Реализовать сортировки (цена/популярность/новизна) и чипы активных фильтров
