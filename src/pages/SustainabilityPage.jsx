...
const SustainabilityPage = () => (
  <div className="container mx-auto py-8 max-w-3xl">
    ...
    <section className="mb-8">
      ...
      <p className="mb-2">Мы стремимся минимизировать воздействие на окружающую среду на всех этапах производства. Используем только сертифицированные материалы и внедряем экологичные технологии.</p>
    ...
    <section className="mb-8">
      ...
      <p className="mb-2">Мы поддерживаем местные сообщества, развиваем программы обучения и заботимся о благополучии сотрудников.</p>
      <ul className="list-disc pl-6 text-gray-700">
    ...
    <section>
      ...
      <p>Мы верим, что роскошь может быть этичной. Каждый ваш выбор — вклад в лучшее будущее для планеты и общества.</p>
    </section>
  </div>
);
