...
const PrivacyPolicyPage = () => (
  <div className="container mx-auto py-8 max-w-3xl">
    ...
    <section className="mb-8">
      ...
      <p className="mb-2">
        Мы собираем только те данные, которые необходимы для оформления заказов, обратной связи и
        улучшения качества сервиса. Ваши данные не передаются третьим лицам без вашего согласия.
      </p>
    ...
    <section className="mb-8">
      ...
      <p className="mb-2">
        Мы используем современные технологии защиты информации: SSL-шифрование, двухфакторная
        аутентификация для сотрудников, регулярные аудиты безопасности.
      </p>
    </section>
    <section className="mb-8">
      ...
      <ul className="list-disc pl-6 text-gray-700 mb-2">
        ...
        <li>
          Для любых вопросов обращайтесь по email:{' '}
          <a href="mailto:privacy@jewelry.com" className="text-tiffany-blue hover:underline">
            privacy@jewelry.com
          </a>
        </li>
      </ul>
    ...
    <section>
      ...
      <p>
        ...
        Дата последнего обновления: 1 июня 2024 г.
      </p>
    </section>
  </div>
)
