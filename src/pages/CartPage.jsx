  ...
  if (!cartItems.length) {
    return (
      <div className="max-w-2xl mx-auto py-16 text-center">
        ...
        <Link to="/products" className="text-tiffany-blue underline">
          Перейти в каталог
        </Link>
      </div>
    )
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="text-2xl font-bold text-tiffany-blue">
          {totalPrice.toLocaleString('ru-RU')} ₽
        </div>
      </div>
      <Button className="bg-tiffany-blue text-white w-full" onClick={() => setCheckoutOpen(true)}>
        Оформить заказ
      </Button>
      <Dialog open={checkoutOpen} onOpenChange={setCheckoutOpen}>
        <DialogContent>
          ...
          <p className="mb-6">
            Сайт находится в демо-версии, оформление заказа временно недоступно.
            <br />
            Пожалуйста, свяжитесь с нами для оформления покупки.
          </p>
          <Button
