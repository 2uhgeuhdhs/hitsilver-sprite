      ...
      <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <DialogContent>
          ...
          <div className="flex gap-4 justify-end">
            <button onClick={cancelRemove} className="px-4 py-2 rounded bg-gray-100 text-gray-700">
              Отмена
            </button>
            <button onClick={confirmRemove} className="px-4 py-2 rounded bg-red-500 text-white">
              Удалить
            </button>
          </div>
        </DialogContent>
