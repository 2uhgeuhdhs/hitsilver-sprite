  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Helmet>
        ...
        <meta
          name="description"
          content="Запишитесь на персональную консультацию с экспертами HIT SILVER GALLERY."
        />
      </Helmet>
        ...
        <div className="prose max-w-none">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="mb-3">
                Посетите наш салон для персональной встречи с ювелирным консультантом. Вы сможете
                примерить украшения и получить профессиональные рекомендации.
              </p>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="mb-3">
                Удобная альтернатива для тех, кто не может посетить салон. Консультация проводится
                через видеосвязь с нашим экспертом.
              </p>
          ...
          <div className="bg-gray-100 p-6 rounded-lg mt-8">
            ...
            <p className="mb-4">
              Заполните форму ниже, и наш менеджер свяжется с вами в ближайшее время для
            ...
            <form className="space-y-4">
              ...
              <div>
                <label htmlFor="consultationType" className="block mb-1 font-medium">
                  Тип консультации
                </label>
                <select
                  id="consultationType"
