      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <img
            ...
            className="mx-auto mb-4 w-20 h-20 object-contain rounded-full shadow border border-gray-200"
          />
          ...
          <div className="mb-4 flex flex-col items-center gap-2">
            ...
            <div className="flex items-center gap-2 text-gray-700 justify-center">
              ...
              <a href="mailto:info@hitsilver.ru" className="hover:underline text-tiffany-blue">
                info@hitsilver.ru
              </a>
            </div>
            <div className="flex items-center gap-2 text-gray-700 justify-center">
              <span className="font-semibold">Телефон:</span>
              <a href="tel:+79000000000" className="hover:underline text-tiffany-blue">
                +7 (900) 000-00-00
              </a>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-tiffany-blue text-white py-2 rounded hover:bg-tiffany-blue-dark transition"
            >
              Отправить
            </button>
          </form>
