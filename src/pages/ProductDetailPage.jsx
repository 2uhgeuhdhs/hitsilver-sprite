  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        ...
        <p className="text-gray-600 mb-8">Извините, мы не можем найти товар, который вы ищете.</p>
          ...
          {JSON.stringify({
            ...
            itemListElement: [
              { '@type': 'ListItem', position: 1, name: 'Главная', item: '/' },
              {
                ...
                item: `/categories/${product.categoryId}`,
              },
              {
                '@type': 'ListItem',
                position: 3,
                name: product.name,
                item: `/products/${product.slug || productId}`,
              },
            ],
          })}
        </script>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex">
            <ol className="flex items-center space-x-2 text-sm text-gray-500">
              ...
              <li>
                <Link to="/products" className="hover:text-tiffany-blue">
                  Все товары
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to={`/categories/${product.categoryId}`} className="hover:text-tiffany-blue">
              ...
              <li className="text-tiffany-blue font-medium">{product.name}</li>
            </ol>
          </nav>
        </div>
      </div>
