...
const RegistryPage = () => (
  <div className="container mx-auto py-8 max-w-2xl">
    ...
    <section className="mb-8">
      ...
      <p className="mb-2">
        Планируете свадьбу или важное событие? Наш реестр подарков поможет вашим близким выбрать
        идеальный подарок из коллекции украшений и аксессуаров.
      </p>
    ...
    <section>
      ...
      <p>
        Наши специалисты помогут подобрать подарки для любого события. Телефон:{' '}
