        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-white/90 max-w-3xl mx-auto">
              ...
              От выбора кольца для помолвки или подарка до предоставления консультаций в магазине или онлайн, 
              мы всегда к вашим услугам.
            </p>
            <Button className="mt-6 bg-white text-tiffany-blue hover:bg-gray-100" onClick={openCallModal}>
              Связаться с нами
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 border border-gray-200 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">Мы предлагаем бесплатную доставку и возврат на все заказы.</p>
              <Button variant="outline" size="sm" className="mt-4" onClick={openDeliveryModal}>Подробнее</Button>
            </div>
            <div className="text-center p-6 border border-gray-200 rounded-lg">
              <div className="w-16 h-16 mx-auto mb-4 bg-gray-100 rounded-full flex items-center justify-center">
              ...
              <Button variant="outline" size="sm" className="mt-4" onClick={openCallModal}>Связаться с нами</Button>
            </div>
            <div className="text-center p-6 border border-gray-200 rounded-lg">
              <div className="w-16 h-16 mx-auto mb-4 bg-gray-100 rounded-full flex items-center justify-center">
                <div className="text-2xl">📅</div>
              ...
              <p className="text-gray-600 text-sm">Мы рады помочь вам с консультацией в магазине или онлайн.</p>
              <Button variant="outline" size="sm" className="mt-4" onClick={openConsultModal}>Записаться</Button>
            </div>
            <div className="text-center p-6 border border-gray-200 rounded-lg">
              <div className="w-16 h-16 mx-auto mb-4 bg-gray-100 rounded-full flex items-center justify-center">
                <div className="text-2xl">🎁</div>
              ...
              <p className="text-gray-600 text-sm">Ваша покупка будет упакована в нашу фирменную подарочную упаковку.</p>
