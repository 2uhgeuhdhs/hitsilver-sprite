...
const BusinessPage = () => (
  <div className="container mx-auto py-8 max-w-2xl">
    ...
    <section className="mb-8">
      ...
      <p className="mb-2">
        Мы предлагаем эксклюзивные решения для корпоративных клиентов: подарочные наборы,
        брендированные украшения и аксессуары для ваших партнёров и сотрудников.
      </p>
    ...
    <section className="mb-8">
      ...
      <p className="mb-2">
        Станьте нашим партнёром и получите доступ к специальным условиям сотрудничества, обучающим
        материалам и поддержке персонального менеджера.
      </p>
    </section>
    <section>
      <h2 className="text-xl font-semibold mb-2">Связаться с отделом B2B</h2>
      <p>
        Для консультации и расчёта индивидуального предложения напишите на{' '}
        <a href="mailto:b2b@jewelry.com" className="text-tiffany-blue hover:underline">
          b2b@jewelry.com
        </a>{' '}
