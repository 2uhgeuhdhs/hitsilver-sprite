...
const CareersPage = () => (
  <div className="container mx-auto py-8 max-w-2xl">
    ...
    <section className="mb-8">
      ...
      <p className="mb-2">
        Мы ценим талант, инициативу и стремление к совершенству. Присоединяйтесь к команде
        профессионалов, создающих ювелирные шедевры!
      </p>
    ...
    <section className="mb-8">
      ...
      <p className="text-gray-600">
        Отправьте резюме на{' '}
        <a href="mailto:hr@jewelry.com" className="text-tiffany-blue hover:underline">
          hr@jewelry.com
        </a>{' '}
        или заполните анкету на сайте.
      </p>
    </section>
    <section>
      <h2 className="text-xl font-semibold mb-2">Стажировки и обучение</h2>
      <p>
        Мы поддерживаем молодых специалистов и предлагаем оплачиваемые стажировки с возможностью
